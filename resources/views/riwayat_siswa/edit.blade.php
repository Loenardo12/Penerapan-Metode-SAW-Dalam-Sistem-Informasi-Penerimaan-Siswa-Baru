                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <br>
                                <form action="{{ route('riwayats.update', $riwayatpengajuan->id) }}" method="POST"
                                    class="forms-sample">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="ID_CALON" id="ID_CALON">
                                            @foreach ($tb_calon_siswa as $p)
                                                <option value="{{ $p->id }}"
                                                    {{ $riwayatpengajuan->ID_CALON == $p->id ? 'selected' : '' }}>
                                                    {{ $p->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tanggal_pengajuan" id="tanggal_pengajuan"
                                            class="form-control" value="{{ $riwayatpengajuan->tanggal_pengajuan }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status_pengajuan" id="status_pengajuan" class="form-control">
                                            <option value="Sudah Diverifikasi"
                                                {{ $riwayatpengajuan->status_pengajuan == 'Sudah Diverifikasi' ? 'selected' : '' }}>
                                                Sudah Diverifikasi</option>
                                            <option value="Belum Diproses"
                                                {{ $riwayatpengajuan->status_pengajuan == 'Belum Diproses' ? 'selected' : '' }}>
                                                Belum Diproses
                                            </option>
                                        </select>
                                    </div>
