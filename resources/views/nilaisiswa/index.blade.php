                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                          <div class="card-body">
                            ...
                            <a class="btn btn-primary mb-5" href="{{route('pinjamans.create')}}"> Tambah Nilai Siswa</a>
                            <a href="{{route('pinjaman.print')}}" class='mb-5 btn btn-primary'> <span
                                class='mdi mdi-printer'></span> Print</a>
                        <table id="mytable" class="display nowrap table table-striped table-bordered">
                                <thead>
                                    <tr><td>Nilai Tes Kesehatan</td></tr>
                                    <tr>
                                        <th>#</th>
                                        <th>Nilai Tes Buta Warna</th>
                                        <th>Nilai Tes Mata Rabun</th>
                                        <th>Nilai Tes Cek fisik</th>
                                ...
                                <thead>
                                    <tr><td>Nilai Ujian Sekolah</td></tr>
                                    <tr>
                                        <th>#</th>
                                ...
                                <thead>
                                    <tr><td>Nilai Ujian Nasional</td></tr>
                                    <tr>
                                        <th>#</th>
                                        <th>Nilai MATEMATIKA</th>
                                        <th>Nilai BAHASA INGGRIS</th>
